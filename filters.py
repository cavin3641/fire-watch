...
NOISE_WORDS = [
    # 선박 화재 (건물 복구와 무관)
    "운반선", "어선", "화물선", "여객선", "선박", "해상", "항구", "부두",
    "유조선", "앞바다", "해역", "정박", "선착장", "예인선", "유람선", "낚싯배", "출항",
    # 소방서 홍보·행사
...
# 소방청 화재 분류 중 '건물'로 볼 것
# 대형화재(시장,공장) = 공장·시장 화재. 복구 규모가 가장 큽니다.
DISPATCH_BUILDING = ["대형화재", "고층건물", "아파트", "일반화재"]
...
FACILITY = [
    ...
    "농막", "축사", "비닐하우스", "주택", "건물",
    "다세대", "연립", "원룸", "고시원", "물류창고", "물류센터", "공장동",
    "상가건물", "주상복합", "오피스", "빌딩", "상가주택", "단독주택",
        "노래방", "PC방", "사우나", "목욕탕", "미용실", "학원", "유치원",
    "요양병원", "교회", "사찰", "절", "성당", "경로당", "어린이집",
        "세차장", "정비소", "정비공장", "제조공장", "작업장", "창고동",
]
